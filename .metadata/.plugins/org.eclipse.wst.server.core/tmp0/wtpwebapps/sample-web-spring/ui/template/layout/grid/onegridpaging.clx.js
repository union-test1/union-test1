/*
 * App URI: template/layout/grid/onegridpaging
 * Source Location: template/layout/grid/onegridpaging.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("template/layout/grid/onegridpaging", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "../template/onegridpaging/getMainList.do";
			...
			(function(container){
				...
				if(typeof onPageindexPagechange == "function") {
					userDefinedControl_2.addEventListener("pagechange", onPageindexPagechange);
				}
