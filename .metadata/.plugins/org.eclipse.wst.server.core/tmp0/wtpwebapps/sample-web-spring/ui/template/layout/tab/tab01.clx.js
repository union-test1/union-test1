/*
 * App URI: template/layout/tab/tab01
 * Source Location: template/layout/tab/tab01.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("template/layout/tab/tab01", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "../tabTemplate/tab01/getMainList.do";
			...
			submission_2.action = "../tabTemplate/tab01/save.do";
			...
			var tabItem_1 = (function(tabFolder){
				...
				(function(container){
					...
					formLayout_1.setRows(["100px", "40px", "1fr", "11px", "40px"]);
					...
					(function(container){
						...
						if(typeof onPageIndexerBeforePagechange == "function") {
							userDefinedControl_2.addEventListener("before-pagechange", onPageIndexerBeforePagechange);
						}
						...
						if(typeof onButton_gridInsert == "function") {
							userDefinedControl_3.addEventListener("insert", onButton_gridInsert);
						}
						if(typeof onButton_gridDelete == "function") {
							userDefinedControl_3.addEventListener("delete", onButton_gridDelete);
						}
						if(typeof onButton_gridReset == "function") {
							userDefinedControl_3.addEventListener("reset", onButton_gridReset);
						}
						...
						group_4.style.setClasses(["grp-buttons"]);
						// Layout
