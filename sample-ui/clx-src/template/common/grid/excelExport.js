...
function onButtonClick4(/* cpr.events.CMouseEvent */e) {
	...
	subSave.setDataRowHandler(function(rowdata) {
		var additionalValue = {
			ori_column1 : rowdata.getOriginalValue("column1"),
			ori_column2 : rowdata.getOriginalValue("column2"),
			ori_column3 : rowdata.getOriginalValue("column3"),
			ori_column4 : rowdata.getOriginalValue("column4")
		};
...
function onButtonClick3(/* cpr.events.CMouseEvent */e) {
	...
	// Excel Export
	comUtil.exportExcel("grdMain", "그리드-엑셀 익스포트");
}
...
/*
 * "Optional Export" 버튼에서 click 이벤트 발생 시 호출. 사용자가 컨트롤을 클릭할 때 발생하는 이벤트.
 */
function onButtonClick2(/* cpr.events.CMouseEvent */e) {

	comUtil.openDialog("example/grid/popup/excelExport_option", 400, 300, function(/* cpr.events.CUIEvent */e) {
		...
		comUtil.exportExcel("grdMain", "그리드-엑셀 익스포트 Optional", returnValue);
