/*
 * App URI: template/layout/grid/md_treegrid
 * Source Location: template/layout/grid/md_treegrid.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("template/layout/grid/md_treegrid", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			var dataSet_2 = new cpr.data.DataSet("resSubList");
			dataSet_2.parseData({
				"columns" : [
					{"name": "column1"},
					{"name": "column2"},
			...
			var dataMap_2 = new cpr.data.DataMap("reqSubKey");
			dataMap_2.parseData({
				"columns" : [{"name": "column1"}]
			});
			app.register(dataMap_2);
			var submission_1 = new cpr.protocols.Submission("subMainList");
			submission_1.action = "../template/md_treegrid/getMainList.do";
			...
			submission_2.action = "../template/md_treegrid/getSubList.do";
			...
			submission_3.action = "../template/md_treegrid/save.do";
			submission_3.addRequestData(dataSet_2);
			if(typeof onSubSaveSubmitSuccess == "function") {
				submission_3.addEventListener("submit-success", onSubSaveSubmitSuccess);
			}
			...
			formLayout_1.setColumns(["350px", "1fr"]);
			...
			(function(container){
				...
				if(typeof onGroupKeydown == "function") {
					group_2.addEventListener("keydown", onGroupKeydown);
				}
				...
				(function(tree_1){
					tree_1.setItemSet(app.lookup("resList"), {
						"label": "column2",
						"value": "column1",
						"parentValue": "column3"
					});
							...
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										...
										inputBox_11.bind("enabled").toExpression("getStateString() *= \"I\"");
