/*
 * App URI: template/layout/tab/tab02
 * Source Location: template/layout/tab/tab02.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("template/layout/tab/tab02", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "../tabTemplate/tab02/getMainList.do";
			...
			submission_2.action = "../tabTemplate/tab02/save.do";
			...
			(function(container){
				...
				var tabItem_1 = (function(tabFolder){
					...
					(function(container){
						...
						formLayout_3.setRows(["40px", "1fr", "11px", "40px"]);
