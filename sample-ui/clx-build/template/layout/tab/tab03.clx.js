/*
 * App URI: template/layout/tab/tab03
 * Source Location: template/layout/tab/tab03.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("template/layout/tab/tab03", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "../tabTemplate/tab03/getMainList.do";
			...
			submission_2.action = "../tabTemplate/tab03/save.do";
			...
			formLayout_1.setRows(["100px", "1fr", "40px"]);
			...
			(function(container){
				...
				var tabItem_1 = (function(tabFolder){
					...
					(function(container){
						...
						formLayout_4.setRows(["40px", "1fr", "11px"]);
