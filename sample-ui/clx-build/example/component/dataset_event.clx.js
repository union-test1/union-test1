/*
 * App URI: example/component/dataset_event
 * Source Location: example/component/dataset_event.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("example/component/dataset_event", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			if(typeof onDs1BeforeInsert == "function") {
				dataSet_1.addEventListener("before-insert", onDs1BeforeInsert);
			}
			if(typeof onDs1Insert == "function") {
				dataSet_1.addEventListener("insert", onDs1Insert);
			}
			if(typeof onDs1BeforeDelete == "function") {
				dataSet_1.addEventListener("before-delete", onDs1BeforeDelete);
			}
			if(typeof onDs1BeforeUpdate == "function") {
				dataSet_1.addEventListener("before-update", onDs1BeforeUpdate);
			}
