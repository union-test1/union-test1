...
{
	var Util = function( /* cpr.core.AppInstance */ app) {
		this._app = app;
	};
	 ...
	 */
	Util.prototype.openClntSearchPop = function(searchbutton /* udc.searchbutton*/ , handler /* Function*/ ) {
		this.openModal("02_dialog/searchPop", 900, 700, function(e /* cpr.events.CUIEvent*/ ) {
			/**
	 ...
	 */
	Util.prototype.openModal = function(appId /* string */ , width /* number */ , height /* number */ , handler /* Function */ , initValue /* {key:value} */ ) {
		var rootApp = this._app.getRootAppInstance();
		if (initValue == null) {
			initValue = {};
		}
